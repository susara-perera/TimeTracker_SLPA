...
const createYourOriginalUsers = async () => {
  try {
    ...
    // Your original users data
    const originalUsers = [
      {
        _id: new mongoose.Types.ObjectId('68916e55a7e38c0bcbb07bfd'),
        firstName: 'Susara',
        lastName: 'Perera',
        ...
        role: 'super_admin',
        division: new mongoose.Types.ObjectId('689443a4c8066bb7f0b32a44'),
        section: new mongoose.Types.ObjectId('6899758a3c6a81481797f3ce'),
      ...
      {
        _id: new mongoose.Types.ObjectId('689aac0d2c82ae6ee8dc53e7'),
        firstName: 'shenuka',
        lastName: 'navod',
      ...
      {
        _id: mongoose.Types.ObjectId('689aac92e285eb58ac012d9f'),
        firstName: 'Amaya',
        lastName: 'Doni',
        email: 'doni@slpa.com',
        employeeId: '0123',
        ...
        role: 'admin',
        division: mongoose.Types.ObjectId('689443a4c8066bb7f0b32a44'),
        section: mongoose.Types.ObjectId('6899758a3c6a81481797f3ce'),
        address: { country: 'Sri Lanka' },
        permissions: {
      ...
      {
        _id: mongoose.Types.ObjectId('689ebb067f15f1a2e6209f99'),
        firstName: 'Bawantha',
        lastName: 'Madhushan',
        ...
        // lockUntil removed to unlock
        __v: 0
      },
      {
        _id: mongoose.Types.ObjectId('68a2c035389ca9582607ca66'),
        firstName: 'sri',
        lastName: 'lanka',
        ...
        role: 'clerk',
        division: mongoose.Types.ObjectId('689443a4c8066bb7f0b32a44'),
        section: mongoose.Types.ObjectId('689975f93c6a81481797f3ed'),
        address: { country: 'Sri Lanka' },
        permissions: {
          users: { create: false, read: true, update: false, delete: false },
          attendance: { create: true, read: true, update: true, delete: false },
      ...
      {
        _id: mongoose.Types.ObjectId('68a6cc9eb8151b2e398aeca1'),
        firstName: 'Hello',
        lastName: 'World',
        ...
        role: 'employee',
        division: mongoose.Types.ObjectId('689443a4c8066bb7f0b32a44'),
        section: mongoose.Types.ObjectId('689976203c6a81481797f400'),
        address: { country: 'Sri Lanka' },
        permissions: {
      ...
      {
        _id: mongoose.Types.ObjectId('68a6d6147f49c91353e34915'),
        firstName: 'admin',
        lastName: 'new',
      ...
      {
        _id: mongoose.Types.ObjectId('68a6ec1beb1a3285b66119f0'),
        firstName: 'admin',
        lastName: 'clerk',
    ...
    console.log('\n⚠️ Note: You may need to reset passwords as the hashed passwords might not work with your original passwords.');
